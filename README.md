...
```javascript
import iterSquaredTriangularSeq from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-sequences-squared-triangular@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-sequences-squared-triangular/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-iter-sequences-squared-triangular/actions/workflows/test.yml?query=branch:v0.2.2
